 ...
 * Helpers for video thumbnails, platform detection, etc.
 */
...
export function getVideoThumbnail(
  ...
  switch (platform) {
    ...
    case 'facebook':
      // Facebook requires API access for thumbnails
...
export function getVideoThumbnailFallback(platform: string): string {
  switch (platform) {
    case 'youtube':
      return '/video-placeholder.jpg';
    case 'tiktok':
