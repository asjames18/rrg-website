...
function ProfileCard({ showActions = true, className = "" }) {
  ...
  useEffect(() => {
    ...
    supabase2.auth.getUser().then(({ data: { user: user2 } }) => {
      setUser(user2);
      if (user2) {
