...
/**
 * Script to fetch complete Bible data from a more reliable API
 */
...
async function fetchChapter(bookName, apiName, chapter) {
  try {
    // Try multiple APIs
    const apis = [
      `https://bible-api.com/${apiName}+${chapter}`,
      `https://bible-api.com/${apiName}+${chapter}?translation=web`,
      `https://bible-api.com/${apiName}+${chapter}?translation=kjv`
    ];
...
async function fetchBibleData() {
  console.log('🚀 Starting to fetch complete Bible data from multiple APIs...');
  ...
  // Save the data
  const outputPath = path.join(__dirname, '../src/data/bible/complete-bible-final.json');
